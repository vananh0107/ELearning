      ...
      <div className="w-full 800px:flex items-center">
        ...
        <div className="800px:w-[50%] w-full">
          ...
          <p className={styles.label}>
            ...
            quia porro suscipit velit expedita incidunt ducimus saepe, libero
            maxime reiciendis fugit aliquid voluptates! Sapiente adipisci
            excepturi sunt dolore reiciendis!
          </p>
        </div>
        <br />
        <br />
