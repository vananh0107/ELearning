...
const DashboardWidgets: FC<Props> = ({ open }) => {
    ...
    if (isLoading && ordersLoading) {
      ...
      if (
        ...
        setUserComparePercentage({
          ...
          previosMonth: usersPreviousMonth,
          percentChange: usersPercentChange,
        });
        setOrdersComparePercentage({
          currentMonth: ordersCurrentMonth,
          previosMonth: ordersPreviousMonth,
  ...
  return (
    <div className="min-h-screen pl-[60px]">
      <div className="grid grid-cols-[75%,25%] pt-[30px]">
        <div className="p-8">
            ...
            <div className="flex items-center p-5 justify-between">
              ...
              <div>
                <CircularProgressWithLabel
                  ...
                  open={open}
                />
                <h5 className="text-black text-center pt-4 dark:text-white">
      ...
      <div className="grid grid-cols-[65%,35%] mt-[-20px]">
        <div className="dark:bg-[#111c43] w-[94%] mt-[30px] h-[40vh] rounded-md shadow m-auto">
